...
function ChatHeader({
  ...
  return (
    <div className="relative flex items-center justify-between border-b px-2.5 pb-[10px] pt-[13px] dark:border-[#252525]">
          ...
          {isSidebar && !isFullScreen && (
            <>
              ...
              <ResizablePanel
                ...
                minSize={24}
                maxSize={24}
                className="bg-panelLight dark:bg-panelDark mb-2 mr-2 hidden h-[calc(100dvh-20px)] shadow-sm md:block md:rounded-2xl md:border md:shadow-sm dark:border-[#252525]"
              >
