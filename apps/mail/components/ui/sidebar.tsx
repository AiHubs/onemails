  ...
  (
    ...
    if (collapsible === 'none') {
      return (
        <div
          className={cn(
            'text-sidebar-foreground bg-[var(--background)] dark:bg-darkBackground flex h-full w-[--sidebar-width] flex-col',
            className,
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="text-sidebar-foreground bg-[var(--background)] dark:bg-darkBackground w-[--sidebar-width] p-4 [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="group-data-[variant=floating]:border-sidebar-border bg-[var(--background)] dark:bg-darkBackground flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
