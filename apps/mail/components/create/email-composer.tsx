...
export function EmailComposer({
  ...
  return (
    <div
      className={cn(
        'flex flex-col no-scrollbar h-[80vh] w-full max-w-[70vw] overflow-hidden rounded-2xl bg-[#FAFAFA] p-0 py-0 shadow-sm dark:bg-[#202020]',
        className,
      )}
    >
      <div className="no-scrollbar grow overflow-y-auto dark:bg-[#1A1A1A] flex flex-col">
        {/* To, Cc, Bcc */}
        <div className="shrink-0 overflow-y-auto border-b pb-2 dark:border-[#252525]">
          <div className="flex justify-between px-3 pt-3">
            <div
              ...
              className="flex w-full items-center gap-2 mr-2"
            >
              <p className="text-sm font-medium text-[#8C8C8C]">To:</p>
              {isAddingRecipients || toEmails.length === 0 ? (
                <div ref={toWrapperRef} className="flex flex-1 flex-wrap items-center gap-2">
            ...
            {attachments && attachments.length > 0 && (
              <Popover modal={true}>
                <PopoverTrigger asChild>
                  <button
                    className="focus-visible:ring-ring flex items-center gap-1.5 rounded-md border bg-white/5 px-2 py-1 text-sm hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 dark:border-[#2B2B2B]"
                ...
                >
                  <div className="flex flex-col">
                    <div className="border-b p-3 dark:border-[#2B2B2B]">
          ...
          <div className="relative">
            ...
            >
              <div className="flex items-center justify-center gap-2.5 pl-0.5">
                <div className="flex h-5 items-center justify-center gap-1 rounded-sm">
                  {aiIsLoading ? (
                    <Loader className="h-3.5 w-3.5 animate-spin fill-[#7135ff] dark:fill-[#a680ff]" />
                  ) : (
                    <Sparkles className="h-3.5 w-3.5 fill-[#7135ff] dark:fill-[#a680ff]" />
                  )}
                </div>
                <div className="hidden text-center text-sm leading-none text-[#7135ff] md:block dark:text-[#a680ff]">
                  Generate
                </div>
              </div>
            </button>
