    ...
    <div className="relative flex-1">
      <form className="relative flex items-center" onSubmit={form.handleSubmit(submitSearch)}>
        ...
        <div className="relative w-full">
          <Input
            placeholder={'Search...'}
            className="text-muted-foreground placeholder:text-muted-foreground/70 h-[32px] w-full select-none rounded-md border border-primary/25 focus:border-primary focus:border-2 bg-white pl-9 pr-14 focus-visible:ring-0 focus-visible:ring-offset-0 dark:border-none dark:bg-[#141414]"
            {...form.register('q')}
            value={q}
